      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex items-center justify-between bg-white dark:bg-zinc-900 p-6 rounded-3xl border border-gray-200 dark:border-zinc-800 shadow-sm">
          <div>
            ...
            <h1 className="text-2xl font-extrabold text-gray-900 dark:text-white">Tourism Media Curation</h1>
          </div>
        </div>

        {/* Upload Box */}
        <form onSubmit={handleUpload} className="bg-white dark:bg-zinc-900 p-5 rounded-2xl border border-gray-200 dark:border-zinc-800 space-y-3">
          ...
          <button type="submit" disabled={uploading} className="px-4 py-2 bg-[#003E83] text-white text-xs font-bold rounded-xl cursor-pointer">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {galleries.map((g) => (
              <div key={g.id} className="relative aspect-square rounded-2xl overflow-hidden group bg-gray-100 dark:bg-zinc-800 border border-gray-200 dark:border-zinc-800">
