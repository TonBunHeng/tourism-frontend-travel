  ...
  if (fetching) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center gap-3">
        ...
        <p className="text-xs font-medium text-gray-500 dark:text-zinc-400">Loading business form...</p>
      </div>
    );
  }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-gray-200 dark:border-zinc-800">
        <div>
          ...
          >
            ...
            <span>{isEdit ? 'Back to Business Profile' : 'Back to Dashboard'}</span>
          </Link>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
            {isEdit ? 'Edit Business Profile' : 'Register New Business'}
          </h1>
          <p className="text-xs text-gray-500 dark:text-zinc-400 mt-0.5">
            Submit your hospitality, dining, hotel, or activity listing for tourist discovery and admin verification.
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white dark:bg-zinc-900 p-6 sm:p-8 rounded-lg border border-gray-200 dark:border-zinc-800 space-y-6 shadow-xs transition-colors">
        ...
        <div className="space-y-4 pt-4 border-t border-gray-100 dark:border-zinc-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label className="text-xs font-semibold text-gray-700 dark:text-zinc-300 block mb-1">Phone</label>
              <input
                type="text"
                name="phone"
            ...
            <div>
              <label className="text-xs font-semibold text-gray-700 dark:text-zinc-300 block mb-1">Email</label>
              <input
                type="email"
                name="email"
            ...
            <div>
              <label className="text-xs font-semibold text-gray-700 dark:text-zinc-300 block mb-1">Website</label>
              <input
                type="text"
                name="website"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="text-xs font-semibold text-gray-700 dark:text-zinc-300 block mb-1">Latitude (Optional)</label>
              <input
                type="text"
                name="latitude"
            ...
            <div>
              <label className="text-xs font-semibold text-gray-700 dark:text-zinc-300 block mb-1">Longitude (Optional)</label>
              <input
                type="text"
                name="longitude"
