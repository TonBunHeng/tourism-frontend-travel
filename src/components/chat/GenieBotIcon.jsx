    ...
    <div className={`relative flex items-center justify-center select-none ${className}`}>
      ...
      >
        <defs>
          ...
          <radialGradient id="genieBg" cx="45%" cy="40%" r="60%">
          ...
          <linearGradient id="genieBodyGrad" x1="0%" y1="0%" x2="0%" y2="100%">
          ...
          {/* Soft top highlight */}
          <linearGradient id="genieHighlight" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <g className={animate ? 'animate-genie-float' : ''}>
          ...
          <g className={animate ? 'animate-genie-blink' : ''} style={{ transformOrigin: '50px 45px' }}>
            {/* Left Eye */}
            <ellipse cx="43.5" cy="44.5" rx="3.2" ry="5.2" fill="url(#eyeGrad)" />
            <circle cx="44.8" cy="42.8" r="1.3" fill="#ffffff" />

            {/* Right Eye */}
            <ellipse cx="56.5" cy="44.5" rx="3.2" ry="5.2" fill="url(#eyeGrad)" />
